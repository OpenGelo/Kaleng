...
namespace MultiWiiGUIControls
{
    class vertical_speed_indicator : MWGUIControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GUI_PAYLOAD.tes.Resource1.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(GUI_PAYLOAD.tes.Resource1.VerticalSpeedNeedle);
