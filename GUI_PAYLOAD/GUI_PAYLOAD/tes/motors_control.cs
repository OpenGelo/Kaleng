...
namespace MultiWiiGUIControls
{
    class MWGUIMotors : MWGUIControl
    {
        ...
        Bitmap bmpQuadX = new Bitmap(GUI_PAYLOAD.tes.Resource1.quadx);
        Bitmap bmpQuadP = new Bitmap(GUI_PAYLOAD.tes.Resource1.quadp);
        Bitmap bmpTri = new Bitmap(GUI_PAYLOAD.tes.Resource1.tri);
        Bitmap bmpY6 = new Bitmap(GUI_PAYLOAD.tes.Resource1.y6);
        Bitmap bmpY4 = new Bitmap(GUI_PAYLOAD.tes.Resource1.y4);
        Bitmap bmpBi = new Bitmap(GUI_PAYLOAD.tes.Resource1.bicopter);
        Bitmap bmpHex6 = new Bitmap(GUI_PAYLOAD.tes.Resource1.hex6);
        Bitmap bmpHex6X = new Bitmap(GUI_PAYLOAD.tes.Resource1.hex6x);
        Bitmap bmpFw = new Bitmap(GUI_PAYLOAD.tes.Resource1.fw);
        Bitmap bmpGimbal = new Bitmap(GUI_PAYLOAD.tes.Resource1.gimbal);
        Bitmap bmpOcto8x = new Bitmap(GUI_PAYLOAD.tes.Resource1.octo8x);
        Bitmap bmpOcto8p = new Bitmap(GUI_PAYLOAD.tes.Resource1.octo8p);
        Bitmap bmpOcto8c = new Bitmap(GUI_PAYLOAD.tes.Resource1.octo8coax);
        Bitmap bmpAirplane = new Bitmap(GUI_PAYLOAD.tes.Resource1.airplane);
        Bitmap bmpHeli120 = new Bitmap(GUI_PAYLOAD.tes.Resource1.heli_120);
        Bitmap bmpHeli90 = new Bitmap(GUI_PAYLOAD.tes.Resource1.heli_90);
        Bitmap bmpVtail = new Bitmap(GUI_PAYLOAD.tes.Resource1.vtail);
