...
namespace MultiWiiGUIControls
{
    class artifical_horizon : MWGUIControl
    {
       ...
       private bool   bIndicatorType      = false;            //normal artifical horizon
        ...
        // Images
       Bitmap bmpBackground = new Bitmap(GUI_PAYLOAD.tes.Resource1.Horizon_Background1);
        Bitmap bmpEmptyBackground = new Bitmap(GUI_PAYLOAD.tes.Resource1.Horizon_empty_Background1);
        Bitmap bmpHorizon = new Bitmap(GUI_PAYLOAD.tes.Resource1.Horizon_GroundSky1);
        Bitmap bmpPlane = new Bitmap(GUI_PAYLOAD.tes.Resource1.Maquette_Avion1);
        Bitmap bmpToggleON = new Bitmap(GUI_PAYLOAD.tes.Resource1.toggle_on1);
        Bitmap bmpToggleOFF = new Bitmap(GUI_PAYLOAD.tes.Resource1.toggle_off1);
        Bitmap bmpRoll = new Bitmap(GUI_PAYLOAD.tes.Resource1.roll1);
        Bitmap bmpPitch = new Bitmap(GUI_PAYLOAD.tes.Resource1.pitch1);
