...
namespace MultiWiiGUIControls
{
    class indicator_lamp : MWGUIControl
    {
        ...
        Bitmap bmpRedOff = new Bitmap(GUI_PAYLOAD.tes.Resource1.i_red_off);
        Bitmap bmpRedOn = new Bitmap(GUI_PAYLOAD.tes.Resource1.i_red_on);
        Bitmap bmpGreenOff = new Bitmap(GUI_PAYLOAD.tes.Resource1.i_green_off);
        Bitmap bmpGreenOn = new Bitmap(GUI_PAYLOAD.tes.Resource1.i_green_on);
