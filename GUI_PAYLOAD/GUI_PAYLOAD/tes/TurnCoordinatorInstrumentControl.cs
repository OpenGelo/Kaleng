...
namespace GUI_PAYLOAD
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GUI_PAYLOAD.tes.Resource1.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(GUI_PAYLOAD.tes.Resource1.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(GUI_PAYLOAD.tes.Resource1.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(GUI_PAYLOAD.tes.Resource1.TurnCoordinatorMarks);
