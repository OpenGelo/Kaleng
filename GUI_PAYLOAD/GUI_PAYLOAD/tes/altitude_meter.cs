...
namespace MultiWiiGUIControls
{
    class altitude_meter : MWGUIControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GUI_PAYLOAD.tes.Resource1.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(GUI_PAYLOAD.tes.Resource1.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(GUI_PAYLOAD.tes.Resource1.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(GUI_PAYLOAD.tes.Resource1.numbers);
