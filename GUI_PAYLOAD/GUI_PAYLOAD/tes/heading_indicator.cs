...
namespace MultiWiiGUIControls
{
    class heading_indicator : MWGUIControl
    {
        ...
        // Images
        Bitmap bmpBackground = new Bitmap(GUI_PAYLOAD.tes.Resource1.HeadingIndicator_Background1);
        Bitmap bmpHeadingwheel = new Bitmap(GUI_PAYLOAD.tes.Resource1.HeadingWeel1);
        Bitmap bmpAircaft = new Bitmap(GUI_PAYLOAD.tes.Resource1.HeadingIndicator_Aircraft1);        
