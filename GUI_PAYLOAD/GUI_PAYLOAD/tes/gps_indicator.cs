...
namespace MultiWiiGUIControls
{
    class GpsIndicatorInstrumentControl : MWGUIControl
    {
        ...
        Bitmap bmpLeftLedGreen = new Bitmap(GUI_PAYLOAD.tes.Resource1.gps_left_led_green1);
        Bitmap bmpLeftLedRed = new Bitmap(GUI_PAYLOAD.tes.Resource1.gps_left_led_red1);

        Bitmap bmpRightLedGreen = new Bitmap(GUI_PAYLOAD.tes.Resource1.gps_right_led_green1);
        Bitmap bmpRightLedRed = new Bitmap(GUI_PAYLOAD.tes.Resource1.gps_right_led_red1);

        Bitmap bmpHeadingWheel = new Bitmap(GUI_PAYLOAD.tes.Resource1.gps_direction1);
        Bitmap bmpSatGreen = new Bitmap(GUI_PAYLOAD.tes.Resource1.gps_sat_green1);
        Bitmap bmpSatRed = new Bitmap(GUI_PAYLOAD.tes.Resource1.gps_sat_red1);
        Bitmap bmpBackGround = new Bitmap(GUI_PAYLOAD.tes.Resource1.gps_background1);
